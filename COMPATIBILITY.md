...
| Shared QF_UFLIA equality exchange and purification | foundation: indexed unary Int→Int, binary Int×Int→Int, and ternary Int×Int×Int→Int functions; collision-free purification inside affine integer arithmetic; exact defining equalities for affine arguments; LIA-to-EUF equality entailment; and EUF-to-LIA equality propagation to a fixed point | direct, affine-argument, unary/binary/ternary, reverse-propagation, satisfiable, 64-case randomized pinned-Z3, SMT-LIB, compile-rejection, and independent cold allocation/throughput gates |
...
Arity above three, mixed built-in signatures, conditionals around applications,
