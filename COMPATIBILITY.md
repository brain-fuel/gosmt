...
| Shared QF_UFLIA equality exchange and purification | foundation: indexed unary Int→Int and binary Int×Int→Int functions, collision-free purification inside affine integer arithmetic, exact defining equalities for affine arguments, LIA-to-EUF equality entailment, and EUF-to-LIA equality propagation to a fixed point | direct, affine-argument, binary, reverse-propagation, satisfiable, 64-case randomized pinned-Z3, SMT-LIB, and independent cold allocation/throughput gates |
...
Shared exchange covers unary and binary Real- and Int-valued applications in
