...
5. Bit-blasting, arrays, algebraic datatypes, strings/sequences, floating point.
   ...
   Repeated-operand addition and multiplication synthesize reverse-rounded,
   forward-validated half or square-root preimages. Subtraction, division, and
   remainder synthesize exact signed-zero, positive-one, or NaN preimages and
