...
func DeclareIntFunction(0 c nat, context Context[c], name string, id int) IntFunc[c] {
	match context { case contextValue(contextID): return fastIntegerFunction(contextID, id, name) }
}

func ApplyIntFunction(0 c nat, function IntFunc[c], argument IntExpr[c]) IntExpr[c] {
...
func FloatingPointAdd(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, left FloatingPointExpr[c, e, s], right FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s] {
	return floatingPointAdd(mode, left, right)
}

func FloatingPointSub(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, left FloatingPointExpr[c, e, s], right FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s] {
	return floatingPointSub(mode, left, right)
}

func FloatingPointMul(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, left FloatingPointExpr[c, e, s], right FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s] {
	return floatingPointMul(mode, left, right)
}

func FloatingPointDiv(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, left FloatingPointExpr[c, e, s], right FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s] {
...
func FloatingPointSqrt(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, value FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s] {
...
func FloatingPointFromReal(exponentBits nat, significandBits nat, 0 c nat, mode smt.FloatingPointRoundingMode, value RealExpr[c]) FloatingPointExpr[c, exponentBits, significandBits] {
