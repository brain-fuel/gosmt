...
//
//goplus:dep BitVecArrayReadAt(0 c nat, 0 indexWidth nat, 0 elementWidth nat, array BitVecArrayExpr[c, indexWidth, elementWidth], index BitVecExpr[c, indexWidth], address BitVecExpr[c, indexWidth], value BitVecExpr[c, elementWidth]) BoolExpr[c]
func BitVecArrayReadAt(array BitVecArrayExpr, index BitVecExpr, address BitVecExpr, value BitVecExpr) BoolExpr {
	...
	case bitVecArrayExprValue:
		...
		case bitVecExprValue:
			...
			switch __gp_m144 := any(address).(type) {
			case bitVecExprValue:
				addressContext := __gp_m144.contextID
				addressFast := __gp_m144.fast

				switch __gp_m145 := any(value).(type) {
				case bitVecExprValue:
					valueContext := __gp_m145.contextID
					valueFast := __gp_m145.fast

					if contextID != indexContext || contextID != addressContext || contextID != valueContext {
						panic("gosmt: erased bit-vector array read context mismatch")
					}
					if arrayFast.kind == bitVecArrayFastSymbol && indexFast.kind == bitVectorFastSymbol && addressFast.kind == bitVectorFastValue && valueFast.kind == bitVectorFastValue {
						return boolExprValue{contextID: contextID, term: smt.BitVectorArraySymbolicReadValueRelation{
...
func StoreBitVecArray(array BitVecArrayExpr, index BitVecExpr, value BitVecExpr) BitVecArrayExpr {
	switch __gp_m146 := any(array).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m146.contextID
		term := __gp_m146.term
		arrayFast := __gp_m146.fast

		switch __gp_m147 := any(index).(type) {
		case bitVecExprValue:
			indexContext := __gp_m147.contextID
			indexTerm := __gp_m147.term
			indexFast := __gp_m147.fast

			switch __gp_m148 := any(value).(type) {
			case bitVecExprValue:
				valueContext := __gp_m148.contextID
				valueTerm := __gp_m148.term
				valueFast := __gp_m148.fast
...
func EqBitVecArray(left BitVecArrayExpr, right BitVecArrayExpr) BoolExpr {
	switch __gp_m149 := any(left).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m149.contextID
		leftTerm := __gp_m149.term
		leftFast := __gp_m149.fast

		switch __gp_m150 := any(right).(type) {
		case bitVecArrayExprValue:
			rightContext := __gp_m150.contextID
			rightTerm := __gp_m150.term
			rightFast := __gp_m150.fast
...
func ModelBitVec(model Model, term BitVecExpr) (smt.BitVectorValue, bool) {
	switch __gp_m151 := any(model).(type) {
	case modelValue:
		contextID := __gp_m151.contextID
		core := __gp_m151.core

		switch __gp_m152 := any(term).(type) {
		case bitVecExprValue:
			termContext := __gp_m152.contextID
			value := __gp_m152.term
			fast := __gp_m152.fast
...
func DeclareIntBinary(context Context, name string, id int) IntBinaryFunc {
	switch __gp_m160 := any(context).(type) {
	case contextValue:
		contextID := __gp_m160.iD
...
func DeclareIntBinaryPredicate(context Context, name string, id int) IntBinaryPredicate {
	switch __gp_m161 := any(context).(type) {
	case contextValue:
		contextID := __gp_m161.iD
...
func DeclareBitVecFunction(domainWidth int, rangeWidth int, context Context, name string, id int) BitVecFunc {
	switch __gp_m163 := any(context).(type) {
	case contextValue:
		contextID := __gp_m163.iD
...
func ApplyBitVecFunction(function BitVecFunc, argument BitVecExpr) BitVecExpr {
	switch __gp_m164 := any(function).(type) {
	case bitVecFuncValue:
		contextID := __gp_m164.contextID
		core := __gp_m164.function
...
func ApplyBitVecBinary(function BitVecBinaryFunc, first BitVecExpr, second BitVecExpr) BitVecExpr {
	switch __gp_m167 := any(function).(type) {
	case bitVecBinaryFuncValue:
		contextID := __gp_m167.contextID
		core := __gp_m167.function

		switch __gp_m168 := any(first).(type) {
		case bitVecExprValue:
			firstContext := __gp_m168.contextID
			firstTerm := __gp_m168.term
			firstFast := __gp_m168.fast

			switch __gp_m169 := any(second).(type) {
			case bitVecExprValue:
				secondContext := __gp_m169.contextID
				secondTerm := __gp_m169.term
				secondFast := __gp_m169.fast
...
func UninterpretedConst(sort int, context Context, name string, id int) UninterpretedExpr {
	switch __gp_m170 := any(context).(type) {
	case contextValue:
		contextID := __gp_m170.iD
...
func DeclareUnary(domain int, codomain int, context Context, name string, id int) UnaryFunc {
	switch __gp_m171 := any(context).(type) {
	case contextValue:
		contextID := __gp_m171.iD
...
func DeclareBinary(first int, second int, codomain int, context Context, name string, id int) BinaryFunc {
	switch __gp_m172 := any(context).(type) {
	case contextValue:
		contextID := __gp_m172.iD
...
func EqBool(left BoolExpr, right BoolExpr) BoolExpr {
	switch __gp_m173 := any(left).(type) {
	case boolExprValue:
		leftContext := __gp_m173.contextID
		leftTerm := __gp_m173.term
		leftFast := __gp_m173.fast

		switch __gp_m174 := any(right).(type) {
		case boolExprValue:
			rightContext := __gp_m174.contextID
			rightTerm := __gp_m174.term
			rightFast := __gp_m174.fast
...
func ModInt(value IntExpr, divisor smt.IntegerValue) IntExpr {
	switch __gp_m177 := any(value).(type) {
	case intExprValue:
		contextID := __gp_m177.contextID
		term := __gp_m177.term
		fast := __gp_m177.fast
...
func ToReal(value IntExpr) RealExpr {
	switch __gp_m178 := any(value).(type) {
	case intExprValue:
		contextID := __gp_m178.contextID
		term := __gp_m178.term
		fast := __gp_m178.fast
...
func ToIntReal(value RealExpr) IntExpr {
	switch __gp_m179 := any(value).(type) {
	case realExprValue:
		contextID := __gp_m179.contextID
		term := __gp_m179.term
		fast := __gp_m179.fast
...
func IsIntReal(value RealExpr) BoolExpr {
	switch __gp_m180 := any(value).(type) {
	case realExprValue:
		contextID := __gp_m180.contextID
		term := __gp_m180.term
		fast := __gp_m180.fast
...
func NewSolver(context Context) Solver {
	switch __gp_m181 := any(context).(type) {
	case contextValue:
		contextID := __gp_m181.iD
...
func Assert(assertion int, solver Solver, formula BoolExpr) Solver {
	switch __gp_m182 := any(solver).(type) {
	case solverValue:
		context := __gp_m182.contextID
		core := __gp_m182.core

		switch __gp_m183 := any(formula).(type) {
		case boolExprValue:
			formulaContext := __gp_m183.contextID
			term := __gp_m183.term
			fast := __gp_m183.fast
...
func Check(solver Solver) Result {
	switch __gp_m184 := any(solver).(type) {
	case solverValue:
		context := __gp_m184.contextID
		core := __gp_m184.core
...
func EvalIntExact(model Model, expression IntExpr) (smt.IntegerValue, bool) {
	...
	case modelValue:
		...
		switch __gp_m192 := any(expression).(type) {
		case intExprValue:
			expressionContext := __gp_m192.contextID
			term := __gp_m192.term
			fast := __gp_m192.fast
...
func EvalDatatype(datatype int, constructors int, model Model, expression DatatypeExpr) (smt.DatatypeValue, bool) {
	...
	case modelValue:
		...
		switch __gp_m194 := any(expression).(type) {
		case datatypeExprValue:
			expressionContext := __gp_m194.contextID
			term := __gp_m194.term
...
func EvalIntArray(model Model, array ArrayExpr[smt.IntSort, smt.IntSort], index smt.IntegerValue) (smt.IntegerValue, bool) {
	...
	case modelValue:
		...
		switch __gp_m196 := any(array).(type) {
		case arrayExprValue[smt.IntSort, smt.IntSort]:
			arrayContext := __gp_m196.contextID
			term := __gp_m196.term
			fast := __gp_m196.fast
...
func EvalBitVecArray(model Model, array BitVecArrayExpr, index smt.BitVectorValue) (smt.BitVectorValue, bool) {
	...
	case modelValue:
		...
		switch __gp_m198 := any(array).(type) {
		case bitVecArrayExprValue:
			arrayContext := __gp_m198.contextID
			term := __gp_m198.term
			fast := __gp_m198.fast
...
func EvalString(model Model, expression StringExpr) (string, bool) {
	switch __gp_m201 := any(model).(type) {
	case modelValue:
		context := __gp_m201.contextID
		core := __gp_m201.core

		switch __gp_m202 := any(expression).(type) {
		case stringExprValue:
			expressionContext := __gp_m202.contextID
			term := __gp_m202.term
			fast := __gp_m202.fast
...
func EvalIntSequence(model Model, expression IntSequenceExpr) (smt.IntegerSequenceValue, bool) {
	switch __gp_m203 := any(model).(type) {
	case modelValue:
		context := __gp_m203.contextID
		core := __gp_m203.core

		switch __gp_m204 := any(expression).(type) {
		case intSequenceExprValue:
			expressionContext := __gp_m204.contextID
			term := __gp_m204.term
			fast := __gp_m204.fast
...
func FloatingPointFromBits(exponentBits int, significandBits int, context Context, bits smt.BitVectorValue) FloatingPointExpr {
	switch __gp_m205 := any(context).(type) {
	case contextValue:
		contextID := __gp_m205.iD
...
func FloatingPointConst(exponentBits int, significandBits int, context Context, name string, id int) FloatingPointExpr {
	switch __gp_m206 := any(context).(type) {
	case contextValue:
		contextID := __gp_m206.iD
...
//goplus:dep FloatingPointSub(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, left FloatingPointExpr[c, e, s], right FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s]
func FloatingPointSub(mode smt.FloatingPointRoundingMode, left FloatingPointExpr, right FloatingPointExpr) FloatingPointExpr {
	return floatingPointSub(mode, left, right)
}

//goplus:dep FloatingPointMul(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, left FloatingPointExpr[c, e, s], right FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s]
func FloatingPointMul(mode smt.FloatingPointRoundingMode, left FloatingPointExpr, right FloatingPointExpr) FloatingPointExpr {
	return floatingPointMul(mode, left, right)
}

//goplus:dep FloatingPointDiv(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, left FloatingPointExpr[c, e, s], right FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s]
func FloatingPointDiv(mode smt.FloatingPointRoundingMode, left FloatingPointExpr, right FloatingPointExpr) FloatingPointExpr {
	return floatingPointDiv(mode, left, right)
}

//goplus:dep FloatingPointFMA(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, left FloatingPointExpr[c, e, s], right FloatingPointExpr[c, e, s], addend FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s]
func FloatingPointFMA(mode smt.FloatingPointRoundingMode, left FloatingPointExpr, right FloatingPointExpr, addend FloatingPointExpr) FloatingPointExpr {
	return floatingPointFMA(mode, left, right, addend)
}

//goplus:dep FloatingPointSqrt(0 c nat, 0 e nat, 0 s nat, mode smt.FloatingPointRoundingMode, value FloatingPointExpr[c, e, s]) FloatingPointExpr[c, e, s]
func FloatingPointSqrt(mode smt.FloatingPointRoundingMode, value FloatingPointExpr) FloatingPointExpr {
