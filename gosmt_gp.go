...
func EqDatatype(left DatatypeExpr, right DatatypeExpr) BoolExpr {
	switch __gp_m25 := any(left).(type) {
	case datatypeExprValue:
		contextID := __gp_m25.contextID
		leftTerm := __gp_m25.term
		switch __gp_m26 := any(right).(type) {
		case datatypeExprValue:
			rightContext := __gp_m26.contextID
			rightTerm := __gp_m26.term
...
func BitVecConst(width int, context Context, name string, id int) BitVecExpr {
	switch __gp_m34 := any(context).(type) {
	case contextValue:
		contextID := __gp_m34.iD
...
func SelectArray[I any, E any](array ArrayExpr[I, E], index smt.Term[I]) smt.Term[E] {
	switch __gp_m40 := any(array).(type) {
...
func StoreArray[I any, E any](array ArrayExpr[I, E], index smt.Term[I], value smt.Term[E]) ArrayExpr[I, E] {
	switch __gp_m41 := any(array).(type) {
	case arrayExprValue[I, E]:
...
func IntArrayConst(context Context, name string, id int) ArrayExpr[smt.IntSort, smt.IntSort] {
	switch __gp_m44 := any(context).(type) {
	case contextValue:
		contextID := __gp_m44.iD
...
func SelectIntArray(array ArrayExpr[smt.IntSort, smt.IntSort], index IntExpr) IntExpr {
	switch __gp_m46 := any(array).(type) {
	case arrayExprValue[smt.IntSort, smt.IntSort]:
		contextID := __gp_m46.contextID
		term := __gp_m46.term
		fast := __gp_m46.fast

		switch __gp_m47 := any(index).(type) {
		case intExprValue:
			indexContext := __gp_m47.contextID
			indexTerm := __gp_m47.term
			indexFast := __gp_m47.fast
...
func StoreIntArray(array ArrayExpr[smt.IntSort, smt.IntSort], index IntExpr, value IntExpr) ArrayExpr[smt.IntSort, smt.IntSort] {
	switch __gp_m48 := any(array).(type) {
	case arrayExprValue[smt.IntSort, smt.IntSort]:
		contextID := __gp_m48.contextID
		term := __gp_m48.term
		fast := __gp_m48.fast

		switch __gp_m49 := any(index).(type) {
		case intExprValue:
			indexContext := __gp_m49.contextID
			indexTerm := __gp_m49.term
			indexFast := __gp_m49.fast

			switch __gp_m50 := any(value).(type) {
			case intExprValue:
				valueContext := __gp_m50.contextID
				valueTerm := __gp_m50.term
				valueFast := __gp_m50.fast
...
func SelectBitVecArray(array BitVecArrayExpr, index BitVecExpr) BitVecExpr {
	switch __gp_m53 := any(array).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m53.contextID
		term := __gp_m53.term
		arrayFast := __gp_m53.fast

		switch __gp_m54 := any(index).(type) {
		case bitVecExprValue:
			indexContext := __gp_m54.contextID
			indexTerm := __gp_m54.term
			indexFast := __gp_m54.fast
...
func StoreBitVecArray(array BitVecArrayExpr, index BitVecExpr, value BitVecExpr) BitVecArrayExpr {
	switch __gp_m55 := any(array).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m55.contextID
		term := __gp_m55.term
		arrayFast := __gp_m55.fast

		switch __gp_m56 := any(index).(type) {
		case bitVecExprValue:
			indexContext := __gp_m56.contextID
			indexTerm := __gp_m56.term
			indexFast := __gp_m56.fast

			switch __gp_m57 := any(value).(type) {
			case bitVecExprValue:
				valueContext := __gp_m57.contextID
				valueTerm := __gp_m57.term
				valueFast := __gp_m57.fast
...
func ModelBitVec(model Model, term BitVecExpr) (smt.BitVectorValue, bool) {
	switch __gp_m60 := any(model).(type) {
	case modelValue:
		contextID := __gp_m60.contextID
		core := __gp_m60.core

		switch __gp_m61 := any(term).(type) {
		case bitVecExprValue:
			termContext := __gp_m61.contextID
			value := __gp_m61.term
			fast := __gp_m61.fast
...
func ApplyBitVecFunction(function BitVecFunc, argument BitVecExpr) BitVecExpr {
	switch __gp_m65 := any(function).(type) {
	case bitVecFuncValue:
		contextID := __gp_m65.contextID
		core := __gp_m65.function
...
func ApplyBitVecBinary(function BitVecBinaryFunc, first BitVecExpr, second BitVecExpr) BitVecExpr {
	switch __gp_m68 := any(function).(type) {
	case bitVecBinaryFuncValue:
		contextID := __gp_m68.contextID
		core := __gp_m68.function

		switch __gp_m69 := any(first).(type) {
		case bitVecExprValue:
			firstContext := __gp_m69.contextID
			firstTerm := __gp_m69.term
			firstFast := __gp_m69.fast

			switch __gp_m70 := any(second).(type) {
			case bitVecExprValue:
				secondContext := __gp_m70.contextID
				secondTerm := __gp_m70.term
				secondFast := __gp_m70.fast
...
func Assert(assertion int, solver Solver, formula BoolExpr) Solver {
	switch __gp_m78 := any(solver).(type) {
	case solverValue:
		context := __gp_m78.contextID
		core := __gp_m78.core

		switch __gp_m79 := any(formula).(type) {
		case boolExprValue:
			formulaContext := __gp_m79.contextID
			term := __gp_m79.term
			fast := __gp_m79.fast
...
func Check(solver Solver) Result {
	switch __gp_m80 := any(solver).(type) {
	case solverValue:
		context := __gp_m80.contextID
		core := __gp_m80.core
...
func EvalBool(model Model, expression BoolExpr) (bool, bool) {
	switch __gp_m83 := any(model).(type) {
	case modelValue:
		context := __gp_m83.contextID
		core := __gp_m83.core

		switch __gp_m84 := any(expression).(type) {
		case boolExprValue:
			expressionContext := __gp_m84.contextID
			term := __gp_m84.term
			fast := __gp_m84.fast
...
func EvalInt(model Model, expression IntExpr) (int64, bool) {
	switch __gp_m85 := any(model).(type) {
	case modelValue:
		context := __gp_m85.contextID
		core := __gp_m85.core

		switch __gp_m86 := any(expression).(type) {
		case intExprValue:
			expressionContext := __gp_m86.contextID
			term := __gp_m86.term
			fast := __gp_m86.fast
...
func EvalIntExact(model Model, expression IntExpr) (smt.IntegerValue, bool) {
	switch __gp_m87 := any(model).(type) {
	case modelValue:
		context := __gp_m87.contextID
		core := __gp_m87.core

		switch __gp_m88 := any(expression).(type) {
		case intExprValue:
			expressionContext := __gp_m88.contextID
			term := __gp_m88.term
			fast := __gp_m88.fast
...
func EvalDatatype(datatype int, constructors int, model Model, expression DatatypeExpr) (smt.DatatypeValue, bool) {
	switch __gp_m89 := any(model).(type) {
	case modelValue:
		context := __gp_m89.contextID
		core := __gp_m89.core

		switch __gp_m90 := any(expression).(type) {
		case datatypeExprValue:
			expressionContext := __gp_m90.contextID
			term := __gp_m90.term
...
func EvalIntArray(model Model, array ArrayExpr[smt.IntSort, smt.IntSort], index smt.IntegerValue) (smt.IntegerValue, bool) {
	switch __gp_m91 := any(model).(type) {
	case modelValue:
		context := __gp_m91.contextID
		core := __gp_m91.core

		switch __gp_m92 := any(array).(type) {
		case arrayExprValue[smt.IntSort, smt.IntSort]:
			arrayContext := __gp_m92.contextID
			term := __gp_m92.term
			fast := __gp_m92.fast
...
func EvalBitVecArray(model Model, array BitVecArrayExpr, index smt.BitVectorValue) (smt.BitVectorValue, bool) {
	...
	case modelValue:
		context := __gp_m93.contextID
		core := __gp_m93.core

		switch __gp_m94 := any(array).(type) {
		case bitVecArrayExprValue:
			arrayContext := __gp_m94.contextID
			term := __gp_m94.term
			fast := __gp_m94.fast
...
func EvalReal(model Model, expression RealExpr) (smt.Rational, bool) {
	switch __gp_m95 := any(model).(type) {
	case modelValue:
		context := __gp_m95.contextID
		core := __gp_m95.core

		switch __gp_m96 := any(expression).(type) {
		case realExprValue:
			expressionContext := __gp_m96.contextID
			term := __gp_m96.term
			fast := __gp_m96.fast
