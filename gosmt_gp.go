...
func EqDatatype(left DatatypeExpr, right DatatypeExpr) BoolExpr {
	switch __gp_m19 := any(left).(type) {
	case datatypeExprValue:
		contextID := __gp_m19.contextID
		leftTerm := __gp_m19.term
		switch __gp_m20 := any(right).(type) {
		case datatypeExprValue:
			rightContext := __gp_m20.contextID
			rightTerm := __gp_m20.term
...
func IntValExact(context Context, value smt.IntegerValue) IntExpr {
	switch __gp_m24 := any(context).(type) {
	case contextValue:
		contextID := __gp_m24.iD
...
func SelectArray[I any, E any](array ArrayExpr[I, E], index smt.Term[I]) smt.Term[E] {
	switch __gp_m34 := any(array).(type) {
...
func StoreArray[I any, E any](array ArrayExpr[I, E], index smt.Term[I], value smt.Term[E]) ArrayExpr[I, E] {
	switch __gp_m35 := any(array).(type) {
	case arrayExprValue[I, E]:
...
func SelectIntArray(array ArrayExpr[smt.IntSort, smt.IntSort], index IntExpr) IntExpr {
	...
	case arrayExprValue[smt.IntSort, smt.IntSort]:
		...
		switch __gp_m41 := any(index).(type) {
		case intExprValue:
			indexContext := __gp_m41.contextID
			indexTerm := __gp_m41.term
			indexFast := __gp_m41.fast
...
func StoreIntArray(array ArrayExpr[smt.IntSort, smt.IntSort], index IntExpr, value IntExpr) ArrayExpr[smt.IntSort, smt.IntSort] {
	switch __gp_m42 := any(array).(type) {
	case arrayExprValue[smt.IntSort, smt.IntSort]:
		contextID := __gp_m42.contextID
		term := __gp_m42.term
		fast := __gp_m42.fast

		switch __gp_m43 := any(index).(type) {
		case intExprValue:
			indexContext := __gp_m43.contextID
			indexTerm := __gp_m43.term
			indexFast := __gp_m43.fast

			switch __gp_m44 := any(value).(type) {
			case intExprValue:
				valueContext := __gp_m44.contextID
				valueTerm := __gp_m44.term
				valueFast := __gp_m44.fast
...
func SelectBitVecArray(array BitVecArrayExpr, index BitVecExpr) BitVecExpr {
	switch __gp_m47 := any(array).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m47.contextID
		term := __gp_m47.term
		arrayFast := __gp_m47.fast

		switch __gp_m48 := any(index).(type) {
		case bitVecExprValue:
			indexContext := __gp_m48.contextID
			indexTerm := __gp_m48.term
			indexFast := __gp_m48.fast
...
func StoreBitVecArray(array BitVecArrayExpr, index BitVecExpr, value BitVecExpr) BitVecArrayExpr {
	switch __gp_m49 := any(array).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m49.contextID
		term := __gp_m49.term
		arrayFast := __gp_m49.fast

		switch __gp_m50 := any(index).(type) {
		case bitVecExprValue:
			indexContext := __gp_m50.contextID
			indexTerm := __gp_m50.term
			indexFast := __gp_m50.fast

			switch __gp_m51 := any(value).(type) {
			case bitVecExprValue:
				valueContext := __gp_m51.contextID
				valueTerm := __gp_m51.term
				valueFast := __gp_m51.fast
...
func EqBitVecArray(left BitVecArrayExpr, right BitVecArrayExpr) BoolExpr {
	switch __gp_m52 := any(left).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m52.contextID
		leftTerm := __gp_m52.term
		leftFast := __gp_m52.fast

		switch __gp_m53 := any(right).(type) {
		case bitVecArrayExprValue:
			rightContext := __gp_m53.contextID
			rightTerm := __gp_m53.term
			rightFast := __gp_m53.fast
...
func ModelBitVec(model Model, term BitVecExpr) (smt.BitVectorValue, bool) {
	...
	case modelValue:
		...
		switch __gp_m55 := any(term).(type) {
		case bitVecExprValue:
			termContext := __gp_m55.contextID
			value := __gp_m55.term
			fast := __gp_m55.fast
...
func ApplyBitVecFunction(function BitVecFunc, argument BitVecExpr) BitVecExpr {
	switch __gp_m59 := any(function).(type) {
	case bitVecFuncValue:
		contextID := __gp_m59.contextID
		core := __gp_m59.function
...
func ApplyBitVecBinary(function BitVecBinaryFunc, first BitVecExpr, second BitVecExpr) BitVecExpr {
	switch __gp_m62 := any(function).(type) {
	case bitVecBinaryFuncValue:
		contextID := __gp_m62.contextID
		core := __gp_m62.function

		switch __gp_m63 := any(first).(type) {
		case bitVecExprValue:
			firstContext := __gp_m63.contextID
			firstTerm := __gp_m63.term
			firstFast := __gp_m63.fast

			switch __gp_m64 := any(second).(type) {
			case bitVecExprValue:
				secondContext := __gp_m64.contextID
				secondTerm := __gp_m64.term
				secondFast := __gp_m64.fast
...
func Assert(assertion int, solver Solver, formula BoolExpr) Solver {
	switch __gp_m72 := any(solver).(type) {
	case solverValue:
		context := __gp_m72.contextID
		core := __gp_m72.core

		switch __gp_m73 := any(formula).(type) {
		case boolExprValue:
			formulaContext := __gp_m73.contextID
			term := __gp_m73.term
			fast := __gp_m73.fast
...
func Check(solver Solver) Result {
	switch __gp_m74 := any(solver).(type) {
	case solverValue:
		context := __gp_m74.contextID
		core := __gp_m74.core
...
func EvalBool(model Model, expression BoolExpr) (bool, bool) {
	switch __gp_m77 := any(model).(type) {
	case modelValue:
		context := __gp_m77.contextID
		core := __gp_m77.core

		switch __gp_m78 := any(expression).(type) {
		case boolExprValue:
			expressionContext := __gp_m78.contextID
			term := __gp_m78.term
			fast := __gp_m78.fast
...
func EvalInt(model Model, expression IntExpr) (int64, bool) {
	switch __gp_m79 := any(model).(type) {
	case modelValue:
		context := __gp_m79.contextID
		core := __gp_m79.core

		switch __gp_m80 := any(expression).(type) {
		case intExprValue:
			expressionContext := __gp_m80.contextID
			term := __gp_m80.term
			fast := __gp_m80.fast
...
func EvalIntExact(model Model, expression IntExpr) (smt.IntegerValue, bool) {
	switch __gp_m81 := any(model).(type) {
	case modelValue:
		context := __gp_m81.contextID
		core := __gp_m81.core

		switch __gp_m82 := any(expression).(type) {
		case intExprValue:
			expressionContext := __gp_m82.contextID
			term := __gp_m82.term
			fast := __gp_m82.fast
...
func EvalIntArray(model Model, array ArrayExpr[smt.IntSort, smt.IntSort], index smt.IntegerValue) (smt.IntegerValue, bool) {
	...
	case modelValue:
		...
		case arrayExprValue[smt.IntSort, smt.IntSort]:
			arrayContext := __gp_m86.contextID
			term := __gp_m86.term
			fast := __gp_m86.fast
...
func EvalBitVecArray(model Model, array BitVecArrayExpr, index smt.BitVectorValue) (smt.BitVectorValue, bool) {
	...
	case modelValue:
		...
		case bitVecArrayExprValue:
			arrayContext := __gp_m88.contextID
			term := __gp_m88.term
			fast := __gp_m88.fast
