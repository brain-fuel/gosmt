...
//goplus:variant (StringExpr) stringExprValue(ContextID int, Term smt.Term[smt.StringSort]) StringExpr[c]
...
func StringVal(context Context, value string) StringExpr {
	...
	case contextValue:
		...
		return stringExprValue{contextID: contextID, term: smt.StringVal(value)}
	default:
		panic("goplus: impossible enum value in match")
	}
}
...
func StringConst(context Context, name string, id int) StringExpr {
	...
	case contextValue:
		...
		return stringExprValue{contextID: contextID, term: smt.StringConst(id, name)}
	default:
		panic("goplus: impossible enum value in match")
	}
}
...
func ConcatString(values ...StringExpr) StringExpr {
	...
	for index, value := range values {
		...
		case stringExprValue:
			current := __gp_m4.contextID
			term := __gp_m4.term

			if index == 0 {
				contextID = current
			} else if current != contextID {
	...
	return stringExprValue{contextID: contextID, term: smt.StringConcat(terms...)}
}
...
func LengthString(value StringExpr) IntExpr {
	...
	case stringExprValue:
		...
		term := __gp_m5.term
		return intExprValue{contextID: contextID, term: smt.StringLength(term), fast: integerFast{}}
	default:
		panic("goplus: impossible enum value in match")
	}
}
...
func ContainsString(value StringExpr, substring StringExpr) BoolExpr {
	...
	case stringExprValue:
		...
		term := __gp_m6.term
		switch __gp_m7 := any(substring).(type) {
		case stringExprValue:
			otherContext := __gp_m7.contextID
			other := __gp_m7.term

			if contextID != otherContext {
				panic("gosmt: erased string context mismatch")
			}
...
func HasPrefixString(value StringExpr, prefix StringExpr) BoolExpr {
	...
	case stringExprValue:
		...
		term := __gp_m8.term
		switch __gp_m9 := any(prefix).(type) {
		case stringExprValue:
			otherContext := __gp_m9.contextID
			other := __gp_m9.term
...
func HasSuffixString(value StringExpr, suffix StringExpr) BoolExpr {
	...
	case stringExprValue:
		...
		term := __gp_m10.term
		switch __gp_m11 := any(suffix).(type) {
		case stringExprValue:
			otherContext := __gp_m11.contextID
			other := __gp_m11.term
...
func EqString(left StringExpr, right StringExpr) BoolExpr {
	...
	case stringExprValue:
		...
		leftTerm := __gp_m12.term
		switch __gp_m13 := any(right).(type) {
		case stringExprValue:
			otherContext := __gp_m13.contextID
			rightTerm := __gp_m13.term
...
func DeclareRecursiveDatatypeConstructor(datatype int, constructors int, constructor int, context Context, name string, selectorName string) DatatypeRecursiveConstructor {
	switch __gp_m16 := any(context).(type) {
	case contextValue:
		contextID := __gp_m16.iD
...
func SelectRecursiveDatatypeConstructor(declaration DatatypeRecursiveConstructor, value DatatypeExpr) DatatypeExpr {
	switch __gp_m19 := any(declaration).(type) {
	case datatypeRecursiveConstructorValue:
		contextID := __gp_m19.contextID
		core := __gp_m19.core
		switch __gp_m20 := any(value).(type) {
		case datatypeExprValue:
			valueContext := __gp_m20.contextID
			term := __gp_m20.term
...
func IsRecursiveDatatypeConstructor(declaration DatatypeRecursiveConstructor, value DatatypeExpr) BoolExpr {
	switch __gp_m21 := any(declaration).(type) {
	case datatypeRecursiveConstructorValue:
		contextID := __gp_m21.contextID
		core := __gp_m21.core
		switch __gp_m22 := any(value).(type) {
		case datatypeExprValue:
			valueContext := __gp_m22.contextID
			term := __gp_m22.term
...
func DeclareBinaryRecursiveDatatypeConstructor(datatype int, constructors int, constructor int, context Context, name string, firstSelectorName string, secondSelectorName string) DatatypeBinaryRecursiveConstructor {
	switch __gp_m23 := any(context).(type) {
	case contextValue:
		contextID := __gp_m23.iD
...
func ApplyBinaryRecursiveDatatypeConstructor(declaration DatatypeBinaryRecursiveConstructor, first DatatypeExpr, second DatatypeExpr) DatatypeExpr {
	...
	case datatypeBinaryRecursiveConstructorValue:
		...
		core := __gp_m24.core
		switch __gp_m25 := any(first).(type) {
		case datatypeExprValue:
			firstContext := __gp_m25.contextID
			firstTerm := __gp_m25.term
			switch __gp_m26 := any(second).(type) {
			case datatypeExprValue:
				secondContext := __gp_m26.contextID
				secondTerm := __gp_m26.term
...
func SelectBinaryRecursiveDatatypeConstructor(field smt.BinaryDatatypeField, declaration DatatypeBinaryRecursiveConstructor, value DatatypeExpr) DatatypeExpr {
	...
	case datatypeBinaryRecursiveConstructorValue:
		...
		case datatypeExprValue:
			valueContext := __gp_m28.contextID
			term := __gp_m28.term
...
func ApplyNaryRecursiveDatatypeConstructor(declaration DatatypeNaryRecursiveConstructor, values vec.Vec[DatatypeExpr]) DatatypeExpr {
	switch __gp_m32 := any(declaration).(type) {
...
func IsNaryRecursiveDatatypeConstructor(declaration DatatypeNaryRecursiveConstructor, value DatatypeExpr) BoolExpr {
	switch __gp_m35 := any(declaration).(type) {
	case datatypeNaryRecursiveConstructorValue:
		contextID := __gp_m35.contextID
		core := __gp_m35.core
		switch __gp_m36 := any(value).(type) {
		case datatypeExprValue:
			valueContext := __gp_m36.contextID
			term := __gp_m36.term
...
func BoolDatatypeMixedArgument(value BoolExpr, rest DatatypeMixedArguments) DatatypeMixedArguments {
	...
	case boolExprValue:
		...
		term := __gp_m39.term
		switch __gp_m40 := any(rest).(type) {
		case datatypeMixedArgumentsValue:
			restContext := __gp_m40.contextID
			core := __gp_m40.core
...
func IntDatatypeMixedArgument(value IntExpr, rest DatatypeMixedArguments) DatatypeMixedArguments {
	...
	case intExprValue:
		...
		term := __gp_m41.term
		switch __gp_m42 := any(rest).(type) {
		case datatypeMixedArgumentsValue:
			restContext := __gp_m42.contextID
			core := __gp_m42.core
			if contextID != restContext {
				panic("gosmt: erased mixed datatype argument context mismatch")
			}
...
func RealDatatypeMixedArgument(value RealExpr, rest DatatypeMixedArguments) DatatypeMixedArguments {
	...
	case realExprValue:
		...
		term := __gp_m43.term
		switch __gp_m44 := any(rest).(type) {
		case datatypeMixedArgumentsValue:
			restContext := __gp_m44.contextID
			core := __gp_m44.core
			if contextID != restContext {
				panic("gosmt: erased mixed datatype argument context mismatch")
			}
...
func BitVecDatatypeMixedArgument(width int, value BitVecExpr, rest DatatypeMixedArguments) DatatypeMixedArguments {
	...
	case bitVecExprValue:
		...
		term := __gp_m45.term
		switch __gp_m46 := any(rest).(type) {
		case datatypeMixedArgumentsValue:
			restContext := __gp_m46.contextID
			core := __gp_m46.core
			if contextID != restContext {
				panic("gosmt: erased mixed datatype argument context mismatch")
			}
...
func SelfDatatypeMixedArgument(value DatatypeExpr, rest DatatypeMixedArguments) DatatypeMixedArguments {
	...
	case datatypeExprValue:
		...
		term := __gp_m47.term
		switch __gp_m48 := any(rest).(type) {
		case datatypeMixedArgumentsValue:
			restContext := __gp_m48.contextID
			core := __gp_m48.core
			if contextID != restContext {
				panic("gosmt: erased mixed datatype argument context mismatch")
			}
...
func DatatypeReferenceMixedArgument(targetDatatype int, targetConstructors int, value DatatypeExpr, rest DatatypeMixedArguments) DatatypeMixedArguments {
	...
	case datatypeExprValue:
		...
		term := __gp_m49.term
		switch __gp_m50 := any(rest).(type) {
		case datatypeMixedArgumentsValue:
			restContext := __gp_m50.contextID
			core := __gp_m50.core
			if contextID != restContext {
...
func ApplyMixedDatatypeConstructor(declaration DatatypeMixedConstructor, arguments DatatypeMixedArguments) DatatypeExpr {
	...
	case datatypeMixedConstructorValue:
		...
		core := __gp_m52.core
		switch __gp_m53 := any(arguments).(type) {
		case datatypeMixedArgumentsValue:
			argumentContext := __gp_m53.contextID
			values := __gp_m53.core
...
func NextMixedDatatypeField(cursor DatatypeMixedCursor) DatatypeMixedCursor {
	switch __gp_m55 := any(cursor).(type) {
...
func SelectMixedBoolDatatypeField(cursor DatatypeMixedCursor, value DatatypeExpr) BoolExpr {
	switch __gp_m56 := any(cursor).(type) {
	case datatypeMixedCursorValue:
...
func SelectMixedIntDatatypeField(cursor DatatypeMixedCursor, value DatatypeExpr) IntExpr {
	switch __gp_m58 := any(cursor).(type) {
	case datatypeMixedCursorValue:
...
func SelectMixedRealDatatypeField(cursor DatatypeMixedCursor, value DatatypeExpr) RealExpr {
	switch __gp_m60 := any(cursor).(type) {
	case datatypeMixedCursorValue:
...
func SelectMixedBitVecDatatypeField(width int, cursor DatatypeMixedCursor, value DatatypeExpr) BitVecExpr {
	switch __gp_m62 := any(cursor).(type) {
	case datatypeMixedCursorValue:
...
func SelectMixedSelfDatatypeField(cursor DatatypeMixedCursor, value DatatypeExpr) DatatypeExpr {
	switch __gp_m64 := any(cursor).(type) {
	case datatypeMixedCursorValue:
...
func SelectMixedDatatypeReferenceField(targetDatatype int, targetConstructors int, cursor DatatypeMixedCursor, value DatatypeExpr) DatatypeExpr {
	switch __gp_m66 := any(cursor).(type) {
	case datatypeMixedCursorValue:
		contextID := __gp_m66.contextID
		core := __gp_m66.core
		switch __gp_m67 := any(value).(type) {
		case datatypeExprValue:
			valueContext := __gp_m67.contextID
			term := __gp_m67.term
			if contextID != valueContext {
...
func IntVal(context Context, value int64) IntExpr {
	switch __gp_m74 := any(context).(type) {
	case contextValue:
		contextID := __gp_m74.iD
...
func IntValExact(context Context, value smt.IntegerValue) IntExpr {
	switch __gp_m75 := any(context).(type) {
	case contextValue:
		contextID := __gp_m75.iD
...
func RealConst(context Context, name string, id int) RealExpr {
	switch __gp_m76 := any(context).(type) {
	case contextValue:
		contextID := __gp_m76.iD
...
func ArrayConst[I any, E any](context Context, name string, id int) ArrayExpr[I, E] {
	switch __gp_m83 := any(context).(type) {
	case contextValue:
		contextID := __gp_m83.iD
...
func SelectArray[I any, E any](array ArrayExpr[I, E], index smt.Term[I]) smt.Term[E] {
	switch __gp_m85 := any(array).(type) {
...
func SelectIntArray(array ArrayExpr[smt.IntSort, smt.IntSort], index IntExpr) IntExpr {
	switch __gp_m91 := any(array).(type) {
	case arrayExprValue[smt.IntSort, smt.IntSort]:
		contextID := __gp_m91.contextID
		term := __gp_m91.term
		fast := __gp_m91.fast

		switch __gp_m92 := any(index).(type) {
		case intExprValue:
			indexContext := __gp_m92.contextID
			indexTerm := __gp_m92.term
			indexFast := __gp_m92.fast
...
func StoreIntArray(array ArrayExpr[smt.IntSort, smt.IntSort], index IntExpr, value IntExpr) ArrayExpr[smt.IntSort, smt.IntSort] {
	switch __gp_m93 := any(array).(type) {
	case arrayExprValue[smt.IntSort, smt.IntSort]:
		contextID := __gp_m93.contextID
		term := __gp_m93.term
		fast := __gp_m93.fast

		switch __gp_m94 := any(index).(type) {
		case intExprValue:
			indexContext := __gp_m94.contextID
			indexTerm := __gp_m94.term
			indexFast := __gp_m94.fast

			switch __gp_m95 := any(value).(type) {
			case intExprValue:
				valueContext := __gp_m95.contextID
				valueTerm := __gp_m95.term
				valueFast := __gp_m95.fast
...
func SelectBitVecArray(array BitVecArrayExpr, index BitVecExpr) BitVecExpr {
	...
	case bitVecArrayExprValue:
		...
		term := __gp_m98.term
		arrayFast := __gp_m98.fast

		switch __gp_m99 := any(index).(type) {
		case bitVecExprValue:
			indexContext := __gp_m99.contextID
			indexTerm := __gp_m99.term
			indexFast := __gp_m99.fast
...
func StoreBitVecArray(array BitVecArrayExpr, index BitVecExpr, value BitVecExpr) BitVecArrayExpr {
	switch __gp_m100 := any(array).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m100.contextID
		term := __gp_m100.term
		arrayFast := __gp_m100.fast

		switch __gp_m101 := any(index).(type) {
		case bitVecExprValue:
			indexContext := __gp_m101.contextID
			indexTerm := __gp_m101.term
			indexFast := __gp_m101.fast

			switch __gp_m102 := any(value).(type) {
			case bitVecExprValue:
				valueContext := __gp_m102.contextID
				valueTerm := __gp_m102.term
				valueFast := __gp_m102.fast
...
func EqBitVecArray(left BitVecArrayExpr, right BitVecArrayExpr) BoolExpr {
	switch __gp_m103 := any(left).(type) {
	case bitVecArrayExprValue:
		contextID := __gp_m103.contextID
		leftTerm := __gp_m103.term
		leftFast := __gp_m103.fast

		switch __gp_m104 := any(right).(type) {
		case bitVecArrayExprValue:
			rightContext := __gp_m104.contextID
			rightTerm := __gp_m104.term
			rightFast := __gp_m104.fast
...
func ModelBitVec(model Model, term BitVecExpr) (smt.BitVectorValue, bool) {
	switch __gp_m105 := any(model).(type) {
	case modelValue:
		contextID := __gp_m105.contextID
		core := __gp_m105.core

		switch __gp_m106 := any(term).(type) {
		case bitVecExprValue:
			termContext := __gp_m106.contextID
			value := __gp_m106.term
			fast := __gp_m106.fast
...
func ApplyBitVecFunction(function BitVecFunc, argument BitVecExpr) BitVecExpr {
	switch __gp_m110 := any(function).(type) {
	case bitVecFuncValue:
		contextID := __gp_m110.contextID
		core := __gp_m110.function
...
func ApplyBitVecBinary(function BitVecBinaryFunc, first BitVecExpr, second BitVecExpr) BitVecExpr {
	switch __gp_m113 := any(function).(type) {
	case bitVecBinaryFuncValue:
		contextID := __gp_m113.contextID
		core := __gp_m113.function

		switch __gp_m114 := any(first).(type) {
		case bitVecExprValue:
			firstContext := __gp_m114.contextID
			firstTerm := __gp_m114.term
			firstFast := __gp_m114.fast

			switch __gp_m115 := any(second).(type) {
			case bitVecExprValue:
				secondContext := __gp_m115.contextID
				secondTerm := __gp_m115.term
				secondFast := __gp_m115.fast
...
func EqBool(left BoolExpr, right BoolExpr) BoolExpr {
	switch __gp_m119 := any(left).(type) {
	case boolExprValue:
		leftContext := __gp_m119.contextID
		leftTerm := __gp_m119.term
		leftFast := __gp_m119.fast

		switch __gp_m120 := any(right).(type) {
		case boolExprValue:
			rightContext := __gp_m120.contextID
			rightTerm := __gp_m120.term
			rightFast := __gp_m120.fast
...
func Assert(assertion int, solver Solver, formula BoolExpr) Solver {
	switch __gp_m125 := any(solver).(type) {
	case solverValue:
		context := __gp_m125.contextID
		core := __gp_m125.core

		switch __gp_m126 := any(formula).(type) {
		case boolExprValue:
			formulaContext := __gp_m126.contextID
			term := __gp_m126.term
			fast := __gp_m126.fast
...
func Check(solver Solver) Result {
	switch __gp_m127 := any(solver).(type) {
	case solverValue:
		context := __gp_m127.contextID
		core := __gp_m127.core
...
func EvalInt(model Model, expression IntExpr) (int64, bool) {
	switch __gp_m132 := any(model).(type) {
	case modelValue:
		context := __gp_m132.contextID
		core := __gp_m132.core

		switch __gp_m133 := any(expression).(type) {
		case intExprValue:
			expressionContext := __gp_m133.contextID
			term := __gp_m133.term
			fast := __gp_m133.fast
...
func EvalIntExact(model Model, expression IntExpr) (smt.IntegerValue, bool) {
	switch __gp_m134 := any(model).(type) {
	case modelValue:
		context := __gp_m134.contextID
		core := __gp_m134.core

		switch __gp_m135 := any(expression).(type) {
		case intExprValue:
			expressionContext := __gp_m135.contextID
			term := __gp_m135.term
			fast := __gp_m135.fast
...
func EvalDatatype(datatype int, constructors int, model Model, expression DatatypeExpr) (smt.DatatypeValue, bool) {
	switch __gp_m136 := any(model).(type) {
	case modelValue:
		context := __gp_m136.contextID
		core := __gp_m136.core

		switch __gp_m137 := any(expression).(type) {
		case datatypeExprValue:
			expressionContext := __gp_m137.contextID
			term := __gp_m137.term
...
func EvalIntArray(model Model, array ArrayExpr[smt.IntSort, smt.IntSort], index smt.IntegerValue) (smt.IntegerValue, bool) {
	switch __gp_m138 := any(model).(type) {
	case modelValue:
		context := __gp_m138.contextID
		core := __gp_m138.core

		switch __gp_m139 := any(array).(type) {
		case arrayExprValue[smt.IntSort, smt.IntSort]:
			arrayContext := __gp_m139.contextID
			term := __gp_m139.term
			fast := __gp_m139.fast
...
func EvalBitVecArray(model Model, array BitVecArrayExpr, index smt.BitVectorValue) (smt.BitVectorValue, bool) {
	...
	case modelValue:
		...
		case bitVecArrayExprValue:
			arrayContext := __gp_m141.contextID
			term := __gp_m141.term
			fast := __gp_m141.fast
